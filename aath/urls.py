...
urlpatterns = [
    ...
    path("psychiatric_counseling_services_offered_by_aathmajyothi_for_bangalore_and_mysore",views.psychiatric_counseling_services_offered_by_aathmajyothi_for_bangalore_and_mysore,name="psychiatric_counseling_services_offered_by_aathmajyothi_for_bangalore_and_mysore"),
